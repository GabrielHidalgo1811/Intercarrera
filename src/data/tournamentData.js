...
export const PLAYERS_DATA = {
  ...
  'Kinesiología': [
    ...
    { name: 'Rodrigo Waall', goals: 2 },
    { name: 'Andrés Castañeda', goals: 2 },
    { name: 'Jorge Fuentes León', goals: 2 },
    { name: 'Tomás Díaz', goals: 2 },
    { name: 'Dylan Mahan', goals: 2 },
    { name: 'Maximiliano Aguilar', goals: 1 },
    { name: 'Cristóbal Fuenzalida', goals: 1 },
  ...
  'Ing Control de Gestión': [
    { name: 'Exequiel Reyes', goals: 3 },
    { name: 'Felipe Pinilla', goals: 5 },
    { name: 'Vicente Orquera', goals: 2 },
    { name: 'Hugo Morales', goals: 3 },
    { name: 'Cristhian Carrion', goals: 1 },
    { name: 'Gabriel Parra', goals: 1 },
    { name: 'Javier Rivera', goals: 1 },
    { name: 'Manuel Garrido', goals: 1 },
    { name: 'Pedro Moraga', goals: 1 },
    { name: 'Jesús Arder', goals: 1 },
    { name: 'Bastian Barrios', goals: 0 },
    { name: 'Lucas Arjona', goals: 0 },
  ],
  'Psicología': [
    { name: 'Maximiliano Bascur', goals: 6 },
    { name: 'Milko Aviles', goals: 2 },
    { name: 'Mateo Díaz', goals: 1 },
    { name: 'Jesús Rubio', goals: 2 },
    { name: 'Vicente Lopez', goals: 2 },
    { name: 'Cristóbal Pérez', goals: 0 },
    { name: 'Felipe Guerrero', goals: 0 },
    { name: 'Franco Riveros', goals: 0 },
    { name: 'Jorshua troncoso', goals: 0 },
    { name: 'Martín Miranda', goals: 1 },
    { name: 'Rodrigo Chacón', goals: 0 },
    { name: 'Sebastián Campos', goals: 1 },
  ],
  'Ing Civil Informática': [
    { name: 'Pablo Jatib', goals: 12 },
    { name: 'Benjamín Contreras', goals: 5, yellowCards: 1 },
    { name: 'Alejandro Del Río', goals: 0 },
    { name: 'Alonso Cornejo', goals: 2 },
    { name: 'Benjamín Osses', goals: 0 },
    { name: 'Diego Mendoza', goals: 0 },
    { name: 'Ignacio Pavez', goals: 0 },
    { name: 'José Lagos', goals: 1 },
  ...
  'Derecho': [
    { name: 'Bastián Toro', goals: 2 },
    { name: 'Yromen Champion', goals: 2 },
    { name: 'Eduardo Benavides', goals: 1 },
  ],
};
...
export const KNOCKOUT_STRUCTURE = {
  quarterFinals: [
    ...
    { id: 'QF2', label: 'QF2', date: 'Viernes 25 Sep',   time: '12:00', homeSeed: '1D', awaySeed: '2C', home: 'Kinesiología', away: 'Administración Pública', homeScore: 5, awayScore: 3, homePen: null, awayPen: null },
    { id: 'QF3', label: 'QF3', date: 'Viernes 25 Sep',   time: '13:00', homeSeed: '1B', awaySeed: '2A', home: 'Ing Control de Gestión', away: 'Derecho', homeScore: 6, awayScore: 4, homePen: null, awayPen: null },
  ...
  semiFinals: [
    { id: 'SF1', label: 'SF1', date: 'Miércoles 30 Sep', time: '13:00', homeFrom: 'QF1', awayFrom: 'QF2', home: 'Psicología', away: 'Kinesiología', homeScore: null, awayScore: null, homePen: null, awayPen: null },
    { id: 'SF2', label: 'SF2', date: 'Miércoles 30 Sep', time: '12:00', homeFrom: 'QF3', awayFrom: 'QF4', home: 'Ing Control de Gestión', away: 'Ing Civil Informática', homeScore: null, awayScore: null, homePen: null, awayPen: null },
  ],
